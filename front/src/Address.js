...
class Address extends Component {
  ...
  render() {
    const { street, additional, houseNumber, handleHouseNumberChange, handleAdditionalChange, handleStreetChange, removeAddress } = this.props
    ...
    return (
      <div class="Address">
        <div>
          ...
          <div class="address">
            <div>{houseNumber} {additional}</div>
            <div>{street}</div>
          </div>
        </div>
        <div class="divider" />
